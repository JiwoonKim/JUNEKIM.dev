...
```java
    ...
    public class Pikachu {
        // 접근이 제한된 필드: 상수와 변수
        private final String TYPE = "피카츄";
        private String owner;
        // 접근이 공개된 생성자 메소드
        public Pikachu(String s) {
            owner = s;
        }
        // 접근이 공개된 메소드
        public void draw() {
...
```java
    ...
    public class Sketch {
        ...
        public static void main(String[] args) {
            ...
            // (피카츄가 두 마리)
            Pikachu pikachu1 = new Pikachu("wild");
            Pikachu pikachu2 = new Pikachu("Ash Ketchum");
            // 만들어진 인스턴스의 메소드 사용
            pikachu1.draw();
        }
    }
